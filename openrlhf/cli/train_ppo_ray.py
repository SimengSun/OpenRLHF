...
if __name__ == "__main__":
    ...
    parser.add_argument("--lr_scheduler", type=str, default="cosine_with_min_lr", help="Learning rate scheduler")
    ...
    parser.add_argument("--experience_output_dir", type=str, default=None)
